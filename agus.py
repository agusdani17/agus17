...
def menu(my_name,my_id):
	...
	print('')
	print('%s[%s01%s] %s𝟏. 𝐂𝐫𝐚𝐜𝐤 𝐏𝐮𝐛𝐥𝐢𝐤'%(P,P,P,P));time.sleep(0.02)
	print('%s[%s02%s] %s𝟐. 𝐂𝐫𝐚𝐜𝐤 𝐅𝐨𝐥𝐥𝐨𝐰𝐞𝐫 %sCRACK'%(P,P,P,P,P));time.sleep(0.02)
	print('%s[%s03%s] %s𝟑. 𝐂𝐫𝐚𝐜𝐤 𝐆𝐫𝐮𝐩%s'%(P,P,P,P,P));time.sleep(0.02)
	print('%s[%s04%s] %s𝟒. 𝐂𝐫𝐚𝐜𝐤 𝐅𝐢𝐥𝐞%s'%(P,P,P,P,P));time.sleep(0.02)
	print('%s[%s06%s] %s𝟓. 𝐇𝐚𝐬𝐢𝐥 𝐂𝐫𝐚𝐜𝐤%s'%(P,P,P,M,N));time.sleep(1)
