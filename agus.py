...
def menu(my_name,my_id):
	...
	print('')
	print('%s[%s01%s] %s𝐂𝐑𝐀𝐂𝐊 𝐏𝐔𝐁𝐋𝐈𝐊'%(P,P,P,P));time.sleep(0.02)
	print('%s[%s02%s] %s𝐂𝐑𝐀𝐂𝐊 𝐅𝐎𝐋𝐋𝐎𝐖𝐄𝐑'%(P,P,P,P,P));time.sleep(0.02)
	print('%s[%s03%s] %s𝐂𝐑𝐀𝐂𝐊 𝐆𝐑𝐔𝐁%s'%(P,P,P,P,P));time.sleep(0.02)
	print('%s[%s04%s] %s𝐂𝐑𝐀𝐂𝐊 𝐅𝐈𝐋𝐄%s'%(P,P,P,P,P));time.sleep(0.02)
	print('%s[%s05%s] %s𝐇𝐀𝐒𝐈𝐋 𝐂𝐑𝐀𝐂𝐊%s'%(P,P,P,P,P));time.sleep(1)
	print('%s[%s0%s] %s𝐊𝐄𝐋𝐔𝐀𝐑%s'%(P,P,P,M,N));time.sleep(1)
